...
function Library:SetIconCustomization(IconName: string, CustomData: table)
    if not Library.IconColors then
        Library.IconColors = {}
    end
    
    if typeof(CustomData) == "Color3" then
        Library.IconColors[IconName] = CustomData
    elseif typeof(CustomData) == "table" then
        Library.IconColors[IconName] = {
            IconColor = CustomData.IconColor or CustomData.Color,
            CircleColor = CustomData.CircleColor,
            CircleTransparency = CustomData.CircleTransparency or 0.9,
            Shape = CustomData.Shape or "Circle",
        }
    end
...
function Library:GetAllAvailableIcons()
    if not FetchIcons then
        return {}
    end
    
    local success, iconList = pcall(function()
        return Icons.Icons or {}
    end)
...
do
    ...
    function Funcs:AddLabel(...)
        ...
        -- Wrap label in scrolling frame for horizontal scroll
        ...
        local ScrollFrame = New("ScrollingFrame", {
            ...
            AutomaticCanvasSize = Label.DoesWrap and Enum.AutomaticSize.None or Enum.AutomaticSize.X,
            ScrollBarThickness = 0,
            ScrollingDirection = Enum.ScrollingDirection.X,
            Visible = not Label.DoesWrap,
            Parent = LabelContainer,
        })

        local TextLabel = New("TextLabel", {
            BackgroundTransparency = 1,
            Size = Label.DoesWrap and UDim2.fromScale(1, 1) or UDim2.new(0, 0, 1, 0),
            AutomaticSize = Label.DoesWrap and Enum.AutomaticSize.None or Enum.AutomaticSize.X,
            Text = Label.Text,
            TextSize = Data.Size,
            TextWrapped = Label.DoesWrap,
            TextTruncate = Label.DoesWrap and Enum.TextTruncate.None or Enum.TextTruncate.None,
            TextXAlignment = Groupbox.IsKeyTab and Enum.TextXAlignment.Center or Enum.TextXAlignment.Left,
            Parent = Label.DoesWrap and LabelContainer or ScrollFrame,
        })
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        local ArrowImage = New("ImageLabel", {
            ...
            Image = ChevronDown and ChevronDown.Url or "",
            ImageColor3 = "FontColor",
            ImageRectOffset = ChevronDown and ChevronDown.ImageRectOffset or Vector2.zero,
            ImageRectSize = ChevronDown and ChevronDown.ImageRectSize or Vector2.zero,
            ImageTransparency = 0,
        ...
        local MenuTable = Library:AddContextMenu(
            ...
            function(Active: boolean)
                ...
                -- Change chevron icon based on state
                if Active then
                    if ChevronUp then
                        ArrowImage.Image = ChevronUp.Url
                        ArrowImage.ImageRectOffset = ChevronUp.ImageRectOffset
                        ArrowImage.ImageRectSize = ChevronUp.ImageRectSize
                    end
                else
                    if ChevronDown then
                        ArrowImage.Image = ChevronDown.Url
                        ArrowImage.ImageRectOffset = ChevronDown.ImageRectOffset
                        ArrowImage.ImageRectSize = ChevronDown.ImageRectSize
                    end
                end
    ...
    function Window:AddTab(...)
        ...
        function Tab:AddGroupbox(Info)
            ...
            do
                ...
                -- Add chevron arrow
                local ArrowDownIcon = Library:GetCustomIcon("gallery-vertical")
                local ArrowRightIcon = Library:GetCustomIcon("plus")
