...
function Library:GetIconColor(IconName: string)
    if Library.IconColors and Library.IconColors[IconName] then
        return Library.IconColors[IconName]
    end
    return nil
end

function Library:GetCustomIcon(IconName: string, CustomColor: Color3?)
    local IconColor = CustomColor or Library:GetIconColor(IconName)
...
do
    ...
    function Funcs:AddOutput(Info)
        ...
        function Output:AddLine(Text, Color)
    ...
    function Window:AddTab(...)
        ...
        do
            ...
            do
                ...
                TabLeft.Size = UDim2.new(0, math.floor(TabContainer.AbsoluteSize.X / 3) - 4, 1, 0)
            ...
            do
                ...
                TabMiddle.Size = UDim2.new(0, math.floor(TabContainer.AbsoluteSize.X / 3) - 4, 1, 0)
                Library:UpdateDPI(TabMiddle, { Size = TabMiddle.Size })
            end
            ...
            do
                ...
                TabRight.Size = UDim2.new(0, math.floor(TabContainer.AbsoluteSize.X / 3) - 4, 1, 0)
        ...
        function Tab:RefreshSides()
		    ...
		    TabLeft.Size = UDim2.new(0, math.floor(TabContainer.AbsoluteSize.X / 3) - 4, 1, -Offset)
		    Library:UpdateDPI(TabLeft, {
		        Position = TabLeft.Position,
		        Size = TabLeft.Size,
		    })
		    
		    TabMiddle.Position = UDim2.new(0.5, 0, 0, Offset)
		    TabMiddle.Size = UDim2.new(0, math.floor(TabContainer.AbsoluteSize.X / 3) - 4, 1, -Offset)
		    ...
		    TabRight.Size = UDim2.new(0, math.floor(TabContainer.AbsoluteSize.X / 3) - 4, 1, -Offset)
        ...
        function Tab:AddGroupbox(Info)
            local BoxHolder = New("Frame", {
                ...
                BackgroundTransparency = 1,
                Size = UDim2.fromScale(1, 0),
                Parent = Info.Side == 1 and TabLeft or (Info.Side == 3 and TabMiddle or TabRight),
            })
            New("UIListLayout", {
                Padding = UDim.new(0, 6),
                Parent = BoxHolder,
            ...
            do
                ...
                local ArrowUpIcon = Library:GetCustomIcon("chevron-up")
            ...
            function Groupbox:SetCollapsed(State)
                ...
                if ArrowIcon then
                    if State then
                        local ArrowUpIcon = Library:GetCustomIcon("chevron-up")
                        if ArrowUpIcon then
                            ArrowIcon.Image = ArrowUpIcon.Url
                            ArrowIcon.ImageRectOffset = ArrowUpIcon.ImageRectOffset
                            ArrowIcon.ImageRectSize = ArrowUpIcon.ImageRectSize
                        end
                    else
                        local ArrowDownIcon = Library:GetCustomIcon("chevron-down")
